...
( function( $, wp ) {
	...
	function SwitchEditors() {
		...
		function switchEditor( id, mode ) {
			...
			var editorHeight, toolbarHeight, container,
			...
			if ( 'tmce' === mode || 'tinymce' === mode ) {
				...
				if ( editor ) {
					editor.show();
//TODO 5.x investigate iframe height in iOS
